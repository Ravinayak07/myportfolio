  ...
  return (
    <div id={id} className="about_container">
      ...
      <p className="about_description">
        ...
        .
        <br />
        <br />I Love making <span className="highlighted_text">Frond-End </span>
        Web Development Projects
        <br />
        <br />I am an <span className="highlighted_text">Cloud</span> Enthusiast
        and also Love contributing to{" "}
